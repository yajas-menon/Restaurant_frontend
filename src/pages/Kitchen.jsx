    ...
    <div className="flex">
      ...
      <div className="min-h-screen w-1/2 flex items-center justify-center bg-white">
        <div className="bg-white border border-slate-800 p-8 rounded-lg shadow-lg w-3/4 max-w-2xl">
          <h2 className="text-4xl font-bold text-center text-zinc-900">Kitchen Issues</h2>
          <p className="text-center text-zinc-600 mb-6 mt-2">Fill out the issues related to kitchen.</p>
